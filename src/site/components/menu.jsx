    ...
    return <nav className="navbar fixed-top navbar-expand-md navbar-dark bg-dark">
        <div className="container">
            <a className="navbar-brand" href="#banner">
                <img className="Imagem" align='left' src="img/perfil.png" alt="" height="60" />
                <p className="logo">Livraria Veiga</p>
            </a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ms-auto">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" aria-current="page" href="#features">Nossos Princípios</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" aria-current="page" href="#testemunho">Momentos</a>
                    </li>
                    <li className="nav-item">
